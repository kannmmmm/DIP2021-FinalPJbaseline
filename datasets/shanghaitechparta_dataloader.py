...
if __name__ == '__main__':
    ...
    test_file_list = '/home/featurize/work/DIP2021-FinalPJbaseline/TrainingTestingFileLists/ShanghaiTechPartA_full_origin_test.txt'
    ...
    # train_file_list = 'D:/year3/DIP2021-FinalPJbaseline/TrainingTestingFileLists/ShanghaiTechPartA_full_origin_train.txt'
    # val_file_list = 'D:/year3/DIP2021-FinalPJbaseline/TrainingTestingFileLists/ShanghaiTechPartA_full_origin_val.txt'
    # test_file_list = 'D:/year3/DIP2021-FinalPJbaseline/TrainingTestingFileLists/ShanghaiTechPartA_full_origin_test.txt'
    # train_dataloader = get_train_shanghaitechpartA_dataloader(labeled_file_list=train_file_list, use_flip=True, batch_size=1)
    # val_dataloader = get_test_shanghaitechpartA_dataloader(file_list=val_file_list)
